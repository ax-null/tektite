...
namespace Tektite
{
    ...
    static const luaL_Reg functions[] = {
        { "new", [](lua_State *L) {
             ...
             lua_pushvalue(L, -1);
             entity->setRef(luaL_ref(L, LUA_REGISTRYINDEX));
        ...
        { "get_tag", [](lua_State *L) {
             ...
             lua_pushnumber(L, entity->getTag());
             return 1;
         } },
        ...
        { "get_size", [](lua_State *L) {
             Entity *entity = (Entity *)lua_touserdata(L, -1);
             lua_pushnumber(L, entity->getWidth());
             lua_pushnumber(L, entity->getHeight());
             return 2;
         } },
        { nullptr, nullptr },
    };
    ...
    void Object::defineEntity(lua_State *L)
    {
        lua_newtable(L);
        lua_pushvalue(L, -1);
